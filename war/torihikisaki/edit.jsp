...
<form action="${f:url('update')}" method="post">
	...
	<div class="contentBox">
		<div class="content">
			...
			<div class="memo">
				サンシャインからの直売売上メールを受信するためには、名前を【サンシャイン】、
				区分を【直売】とした取引先を登録して、以下のアドレスに売上メールを転送してください。
				<br/>直売売上メールの転送先：uriage${f:h(key.id)}@agriapp.appspotmail.com
				<!--旧仕様 <br/>もしくは、${f:h(loginUser.yagoRef.model.key)}@agriapp.appspotmail.com -->
			</div>
			...
			<hr/>
			<button type="submit">取引先変更</button>

...
<body onload="<c:if test="${skListArray==null}">initHosoAll();</c:if>setInterval('calc()',500);">
		...
		<form action="${f:url('insert')}" method="post">
			...
			<table>
				...
				<tr>
					<th>取引先</th>
					<td colspan="3">
						<select onchange="initHosoAll();" id="torihikisakiRef" name="torihikisakiRef">
							<c:forEach var="e" items="${tList}">

...
<hr/>
N：
<input type="text" maxlength="4" ${f:text("seibunN")} class="num ${f:errorClass('seibunN', 'err')}"/>
<br/><span class="${f:errorClass('seibunN', 'err')}">${f:h(errors.seibunN)}</span>
<hr/>
N係数：
<input type="text" maxlength="4" ${f:text("nkeisu")} class="num ${f:errorClass('nkeisu', 'err')}"/>
<br/><span class="${f:errorClass('nkeisu', 'err')}">${f:h(errors.nkeisu)}</span>
<hr/>
P：
<input type="text" maxlength="4" ${f:text("seibunP")} class="num ${f:errorClass('seibunP', 'err')}"/>
<br/><span class="${f:errorClass('seibunP', 'err')}">${f:h(errors.seibunP)}</span>
<hr/>
K：
<input type="text" maxlength="4" ${f:text("seibunK")} class="num ${f:errorClass('seibunK', 'err')}"/>
<br/>	<span class="${f:errorClass('seibunK', 'err')}">${f:h(errors.seibunK)}</span>
<hr/>
Ca：
<input type="text" maxlength="4" ${f:text("seibunCa")} class="num ${f:errorClass('seibunCa', 'err')}"/>
<br/><span class="${f:errorClass('seibunCa', 'err')}">${f:h(errors.seibunCa)}</span>
<hr/>
Mg：
<input type="text" maxlength="4" ${f:text("seibunMg")} class="num ${f:errorClass('seibunMg', 'err')}"/>
<br/><span class="${f:errorClass('seibunMg', 'err')}">${f:h(errors.seibunMg)}</span>
<hr/>
B：
<input type="text" maxlength="4" ${f:text("seibunB")} class="num ${f:errorClass('seibunB', 'err')}"/>
<br/><span class="${f:errorClass('seibunB', 'err')}">${f:h(errors.seibunB)}</span>
<hr/>
Mn：
<input type="text" maxlength="4" ${f:text("seibunMn")} class="num ${f:errorClass('seibunMn', 'err')}"/>
<br/><span class="${f:errorClass('seibunMn', 'err')}">${f:h(errors.seibunMn)}</span>
<hr/>
Fe：
<input type="text" maxlength="4" ${f:text("seibunFe")} class="num ${f:errorClass('seibunFe', 'err')}"/>
<br/><span class="${f:errorClass('seibunFe', 'err')}">${f:h(errors.seibunFe)}</span>
<hr/>
kg/袋：
<input type="text" maxlength="4" ${f:text("weight")} class="num ${f:errorClass('weight', 'err')}"/>
<br/><span class="${f:errorClass('weight', 'err')}">${f:h(errors.weight)}</span>
<hr/>
<input class="w50" type="submit" value="肥料登録"/>

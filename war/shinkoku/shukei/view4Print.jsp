...
<tr>
<c:set var="sannyu" value="${e.karikata*e.tekiyo.wariai/100}"/>
...
<td class="num"><fmt:formatNumber value="${sannyu}" pattern="###,###,##0"/></td>
<td class="num"><fmt:formatNumber value="${e.karikata-sannyu}" pattern="###,###,##0"/></td>
</tr>
<c:set var="sumKari" value="${sumKari+e.karikata}"/>
<c:set var="sumKashi" value="${sumKashi+e.kashikata}"/>
<c:set var="sumSannyu" value="${sumSannyu+sannyu}"/>
<c:set var="sumKobunsagaku" value="${sumKobunsagaku+e.karikata-sannyu}"/>
</c:forEach>
<tr>
<td>計</td>

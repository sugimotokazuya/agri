...
<form action="${f:url('update')}" method="post">
	...
	<div class="contentBox">
		<div class="content">
			...
			<h2>状態</h2>
			<input id="s0" type="radio" ${f:radio("status", "0")}/><label for="s0">進行中</label>
			<input id="s1" type="radio" ${f:radio("status", "1")}/><label for="s1">完了済</label>
			
			<hr/>
			<button type="submit">作付変更</button>

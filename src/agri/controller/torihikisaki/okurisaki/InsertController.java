...
public class InsertController extends BaseController {
    ...
    public boolean validateAuth() {
        Torihikisaki t = tService.get(asKey("tKey"), asLong("tVersion"));
    ...
    public Navigation run() throws Exception {
        ...
        Okurisaki okurisaki = new Okurisaki();
        BeanUtil.copy(request, okurisaki);
        okurisaki.getTorihikisakiRef().setModel(t);
        okurisaki.getYagoRef().setModel(loginYago);
        
        service.insert(okurisaki);

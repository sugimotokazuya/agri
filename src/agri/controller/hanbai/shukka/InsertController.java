...
public class InsertController extends BaseController {
    ...
    public boolean validateAuth() {
        Torihikisaki torihikisaki = tService.get(asKey("torihikisakiRef"));
    ...
    public Navigation run() throws Exception {
     ...
     // TODO 取引先が直売の場合は同じ品目でShukkaRecに登録させないようにしないといけない
        ...
        shukka.getYagoRef().setModel(loginYago);
    ...
    protected boolean validate() {
        ...
        v.add("suryo1", v.required(), v.maxlength(5), v.doubleType(), v.doubleRange(1, 999));
        v.add("hinmoku1", v.maxlength(Const.KEY_LENGTH));
        v.add("shukkaKeitai1", v.maxlength(Const.KEY_LENGTH));
        v.add("kakudukeTantoRef", v.maxlength(Const.KEY_LENGTH));
        ...
        v.add("itemCount", v.required(), v.integerType());
